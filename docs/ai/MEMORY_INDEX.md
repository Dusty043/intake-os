...
- `docs/ai/tasks/HANDOFF-0023E-github-credentials.md`
- `docs/ai/tasks/HANDOFF-0025-email-intake.md`
- `docs/ai/tasks/HANDOFF-0026-google-chat-intake.md`
- `docs/ai/tasks/HANDOFF-task14p-through-23.md`
...
- `docs/ai/tasks/TASK-0020-handoff.md`
...
- `docs/ai/tasks/TASK-0035-ux-friction-backlog.md`
...
- `docs/ai/tasks/TASK-0053-discovery-initial-message-solutions-gap.md`
- `docs/ai/tasks/TASK-0054-discovery-auto-artifacts-and-clarification-drawer.md`
- `docs/ai/tasks/TASK-0055-discovery-to-intake-transfer-fixes.md`
- `docs/ai/tasks/TASK-0056-model-tiering-gpt-5-6-sol-terra.md`
- `docs/ai/tasks/TASK-0057-discovery-to-intake-draft-race-fix.md`
- `docs/ai/tasks/TASK-0058-concurrency-hardening-q-conc-1-2.md`
- `docs/ai/tasks/TASK-0059-openai-strict-schema-required-fields.md`
- `docs/ai/tasks/TASK-0060-distribution-planner-board-group-fix.md`
- `docs/ai/tasks/TASK-0061-discovery-clarification-reblocking-fix.md`
- `docs/ai/tasks/TASK-0062-manifest-generation-truncated-json-500.md`
- `docs/ai/tasks/TASK-0063-eval-failed-retry-and-maxtokens-default.md`
- `docs/ai/tasks/TASK-0064-custom-build-verbosity-bound.md`
...
- `docs/ai/tasks/TASK-DISCOVERY-PHASE4.md`
- `docs/ai/tasks/TASK-DISCOVERY-PHASE5.md`
- `docs/ai/tasks/TASK-DISCOVERY-PHASE6.md`
...
- `docs/integrations/INTEGRATION-CHECKLIST.md`
- `docs/integrations/INTEGRATION-SETUP-GUIDE.md`
